...
from transport_matters.addon import (
...
from transport_matters.breakpoint import PausedFlow
...
from transport_matters.pause_session import _paused_event_payload
from transport_matters.storage.base import PipelineStats, SpawnAnchor
...
class _SeqCounter:
    ...
    Structurally satisfies the Protocol in transport_matters.counting. Each call
