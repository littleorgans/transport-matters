...
from manicure import addon_handlers, broadcast
...
from manicure.overrides import OverrideAudit, get_store
...
if TYPE_CHECKING:
    ...
    from manicure.counting import TokenCountingClient
...
async def test_http_response_hook_finalizes_same_exchange_and_observes_response(
    ...
    monkeypatch.setattr(
        "manicure.exchange_recorder._persist_track_assignment",
...
async def test_http_drop_wins_over_finalize(
    ...
    monkeypatch.setattr(
        "manicure.exchange_recorder._finalize_http_provisional_exchange",
        fail_finalize,
    )
