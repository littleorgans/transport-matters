...
**Tech Stack:** Python, pytest, dataclasses, Transport Matters IR objects.
...
**Files:**
- Modify: `api/src/transport_matters/test_track_manager.py`
...
**Files:**
- Read only: `~/.transport-matters/workspaces/helioy-transport-matters-worktrees-nancy-alp-1847/dc1dcbca/index.jsonl`
